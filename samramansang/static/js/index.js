...
function createNeutralPose() {
    return [
        ...
        [0.545, 0.50, 1.0],  // 7: left_elbow (반전: right_elbow 위치)
        [0.45, 0.45, 1.0],  // 8: right_elbow (반전: left_elbow 위치)
        [0.515, 0.54, 1.0],  // 9: left_wrist (반전: right_wrist 위치)
        [0.47, 0.58, 1.0],  // 10: right_wrist (반전: left_wrist 위치)
